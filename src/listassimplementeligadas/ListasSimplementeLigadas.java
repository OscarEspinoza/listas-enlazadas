...
public class ListasSimplementeLigadas {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        window1.addComponent(new Button("Limpiar lista", new Action() {
         ...
         window1.addComponent(new Button("Contar los elementos de la lisa", new Action() {
            @Override
            public void doAction() {
                Lista<Integer> ListasUtil= new Lista<Integer>();//textArea.appendLine(appendBox.getText());  
                ListasUtil.contar();
            }
        }));
